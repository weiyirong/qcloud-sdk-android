    ...
    public ListenableFuture<Result> startWork() {
        ...
        return CallbackToFutureAdapter.getFuture(completer -> {
            ...
            transferSpecDao.getTransferSpecsLiveData(transferSpecId).observeForever(transferSpec -> {
                ...
                TransferManager transferManager = fromServiceEgg(context, transferSpec.getServiceEgg());
                ...
                transferManager.upload(transferSpec.bucket, transferSpec.key, transferSpec.filePath, transferSpec.uploadId);
