 ...
 */
public class PutBucketVersioningRequestTest extends ApplicationTestCase {

    static final String TAG = "Unit_Test";

    volatile boolean isOver = false;

    public PutBucketVersioningRequestTest() {
        super(Application.class);
    }

    @Test
    public void setEnableVersion() throws Exception {
    }
