...
public class UtilsTest extends ApplicationTestCase {
    ...
    public void testEnum() throws Exception{
        ...
        result = Permission.WRITE.getPermission();
    ...
    @Test public void test() throws Exception {
        ...
        byte[] hmacSha1 = (QCEncryptUtils.hmacSha1("secret_key", "secret_id"));

        Log.d("TAG", new String(QCHexUtils.encodeHex(hmacSha1))); // 用secretKey来加密keyTime
    }
}
