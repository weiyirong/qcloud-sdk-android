 ...
 * author bradyxiao
 * Get Bucket Lifecycle is used to read the lifecycle management configuration.
 * If the configuration does not exist, return 404 not found.
 */
public class GetBucketLifecycleRequest extends CosXmlRequest {
    ...
    public void build() {
        ...
        responseBodySerializer = new ResponseXmlS3BodySerializer(GetBucketLifecycleResult.class);
    }
