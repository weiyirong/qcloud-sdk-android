 ...
 * </p>
 *
 * @see com.tencent.cos.xml.CosXml#getBucketCORS(GetBucketCORSRequest)
 * @see com.tencent.cos.xml.CosXml#getBucketCORSAsync(GetBucketCORSRequest, CosXmlResultListener)
 */
final public class GetBucketCORSRequest extends CosXmlRequest {
    ...
    protected void build() throws CosXmlClientException {
        ...
        responseBodySerializer = new ResponseXmlS3BodySerializer(GetBucketCORSResult.class);
    }
