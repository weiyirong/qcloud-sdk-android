 ...
 * </p>
 *
 * @see com.tencent.cos.xml.CosXml#deleteBucketTagging(DeleteBucketTaggingRequest)
 * @see com.tencent.cos.xml.CosXml#deleteBucketTaggingAsync(DeleteBucketTaggingRequest, CosXmlResultListener)
 */
final public class DeleteBucketTaggingRequest extends CosXmlRequest {
    ...
    protected void build() throws CosXmlClientException {
        ...
        responseBodySerializer = new ResponseXmlS3BodySerializer(DeleteBucketTaggingResult.class);
    }
