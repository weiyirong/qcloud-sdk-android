...
/**
 * this is a async task for transfer objects, and it will pause/resume the task when the network is disconnect/reconnect.
 *
...
public class UploadRunnable implements Runnable {
    ...
    UploadRunnable(UploadService uploadService, final String id, TransferStatusManager transferStatusManager) {
