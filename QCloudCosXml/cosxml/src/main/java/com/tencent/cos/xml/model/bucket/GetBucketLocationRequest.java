 ...
 * author bradyxiao
 * Get Bucket Location API is used to acquire information of the region to which a Bucket belongs.
 * Only the Bucket owner is allowed to read the information.
 */
public class GetBucketLocationRequest extends CosXmlRequest {
