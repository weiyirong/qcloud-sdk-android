...
@Deprecated
public class ServerSessionCredentialProvider extends BasicLifecycleCredentialProvider {
    ...
    public ServerSessionCredentialProvider(String secretId, String secretKey, String appid, String userAgent) {
                ...
                try {
                    ...
                    if (data != null) {
                        ...
                        if (credentials != null) {
                            ...
                            QCloudLogger.d("token is %s, secret id is %s, secret key is %s", sessionToken, tmpSecretId, tmpSecretKey);
