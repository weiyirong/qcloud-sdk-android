...
public class TaskExecutors {
    ...
    public static final ThreadPoolExecutor STREAMING_EXECUTOR;

    private static final ThreadPoolExecutor CORE_EXECUTOR;
    ...
    static {
        ...
        STREAMING_EXECUTOR = new ThreadPoolExecutor(5, 5, 5L,
                TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(128),
                new TaskThreadFactory("Streaming-"));
        CORE_EXECUTOR = new ThreadPoolExecutor(2, 2, 5L,
                TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(128),
                new TaskThreadFactory("Core-"));
        UI_THREAD_EXECUTOR = new UIThreadExecutor();

        STREAMING_EXECUTOR.allowCoreThreadTimeOut(true);
        COMMAND_EXECUTOR.allowCoreThreadTimeOut(true);
        CORE_EXECUTOR.allowCoreThreadTimeOut(true);
    }
