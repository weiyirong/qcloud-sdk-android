...
public abstract class CosXmlRequest<T extends QCloudResult> extends QCloudHttpRequest<T> {
    ...
    @Override
    public QCloudHttpRequest setSignerType(String signerType) {
        return super.setSignerType(signerType);
    }
    ...
    public void setExpect(String expect) {
        ...
        this.expect = expect;
        requestHeaders.put("Expect",expect);
    }
    ...
    protected void build() throws QCloudClientException {
        checkParameters();
        requestOriginBuilder.scheme(QCloudNetWorkConstants.Scheme.HTTP);
        requestOriginBuilder.hostAddFront(CosXmlServiceConfig.getInstance().getHttpHost());
    }

    protected abstract void checkParameters() throws QCloudClientException;
}
