...
jstring COSQuic::GetState(JNIEnv *env, const jobject jcaller) {
    ...
    sprintf(buf, "is_valid=%s,is_quic=%s,is_0rtt=%s,connect_ms=%lld,ttfb_ms=%lld,"
                 "complete_ms=%lld,srtt_us=%lld,packets_sent=%lld,packets_retransmitted=%lld,bytes_sent=%lld,"
                 "bytes_retransmitted=%lld,packets_lost=%lld,packets_received=%lld,bytes_received=%lld,"
                 "stream_bytes_received=%lld",
